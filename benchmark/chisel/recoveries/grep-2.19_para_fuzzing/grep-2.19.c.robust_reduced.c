...
void version_etc_arn(FILE *stream, char const *command_name,
...

  {
    ...
    }
    {
      tmp = gettext("(C)");
      fprintf((FILE * /* __restrict  */) stream,
              (char const * /* __restrict  */)(version_etc_copyright), tmp,
              2014);
      tmp___0 =
      ...
      fputs_unlocked((char const * /* __restrict  */)((char const *)tmp___0),
  ...
  case_2 : {
    ...
    fprintf((FILE * /* __restrict  */) stream,
            (char const * /* __restrict  */)((char const *)tmp___2),
            *(authors + 0), *(authors + 1));
  }
    goto switch_break;
  case_3 : {
    ...
    fprintf((FILE * /* __restrict  */) stream,
            (char const * /* __restrict  */)((char const *)tmp___3),
  ...
  case_4 : {
    ...
    fprintf((FILE * /* __restrict  */) stream,
            (char const * /* __restrict  */)((char const *)tmp___4),
  ...
  case_5 : {
    ...
    fprintf((FILE * /* __restrict  */) stream,
            (char const * /* __restrict  */)((char const *)tmp___5),
            *(authors + 0), *(authors + 1), *(authors + 2), *(authors + 3),
            *(authors + 4));
  }
    goto switch_break;
  case_6 : {
    ...
    fprintf((FILE * /* __restrict  */) stream,
            (char const * /* __restrict  */)((char const *)tmp___6),
            *(authors + 0), *(authors + 1), *(authors + 2), *(authors + 3),
            *(authors + 4), *(authors + 5));
  }
    goto switch_break;
  case_7 : {
    ...
    fprintf((FILE * /* __restrict  */) stream,
            (char const * /* __restrict  */)((char const *)tmp___7),
            *(authors + 0), *(authors + 1), *(authors + 2), *(authors + 3),
  ...
  case_8 : {
    ...
    fprintf((FILE * /* __restrict  */) stream,
            (char const * /* __restrict  */)((char const *)tmp___8),
            *(authors + 0), *(authors + 1), *(authors + 2), *(authors + 3),
            *(authors + 4), *(authors + 5), *(authors + 6), *(authors + 7));
  }
    goto switch_break;
  case_9 : {
    tmp___9 = gettext("Written by %s, %s, %s,\n%s, %s, %s, %s,\n%s, and %s.\n");
    fprintf((FILE * /* __restrict  */) stream,
            (char const * /* __restrict  */)((char const *)tmp___9),
            *(authors + 0), *(authors + 1), *(authors + 2), *(authors + 3),
            *(authors + 4), *(authors + 5), *(authors + 6), *(authors + 7),
            *(authors + 8));
  }
  ...
  switch_default : {
    tmp___10 = gettext(
        "Written by %s, %s, %s,\n%s, %s, %s, %s,\n%s, %s, and others.\n");
    fprintf((FILE * /* __restrict  */) stream,
            (char const * /* __restrict  */)((char const *)tmp___10),
            *(authors + 0), *(authors + 1), *(authors + 2), *(authors + 3),
            *(authors + 4), *(authors + 5), *(authors + 6), *(authors + 7),
            *(authors + 8));
  }
    ...
    if (tmp___1) {
      ...
      if (!tmp) {
        ...
        __assert_fail("mbsinit (&iter->state)",
                      "/home/khheo/project/benchmark/grep-2.19/lib/mbiter.h",
                      142U, "mbiter_multi_next");
      }
      iter->in_shift = (_Bool)1;
    with_shift : {
      iter->cur.bytes = mbrtowc((wchar_t * /* __restrict  */)(&iter->cur.wc),
                                (char const * /* __restrict  */)iter->cur.ptr,
                                (size_t)(iter->limit - iter->cur.ptr),
        ...
        if (iter->cur.bytes == 0xfffffffffffffffeUL) {
          ...
          if (iter->cur.bytes == 0UL) {
            ...
            if (!((int const) * (iter->cur.ptr) == 0)) {
              ...
              __assert_fail(
                  "*iter->cur.ptr == \'\\0\'",
                  "/home/khheo/project/benchmark/grep-2.19/lib/mbiter.h", 169U,
                  "mbiter_multi_next");
            }
            if (!(iter->cur.wc == 0)) {
              ...
              __assert_fail(
                  "iter->cur.wc == 0",
                  "/home/khheo/project/benchmark/grep-2.19/lib/mbiter.h", 170U,
                  "mbiter_multi_next");
            }
          }
          {
      ...
      switch_break___0:;
        if (backslash_escapes) {
          ...
          _L___3:
            if (quote_these_too) {
              if (!((*(quote_these_too +
                       (unsigned long)c / (sizeof(int) * 8UL)) >>
                     (unsigned long)c % (sizeof(int) * 8UL)) &
                    1U)) {
                goto _L___2;
              }
        ...
        if (iter->cur.bytes == 0xfffffffffffffffeUL) {
          ...
          if (iter->cur.bytes == 0UL) {
            ...
            if (!((int const) * (iter->cur.ptr) == 0)) {
              ...
              __assert_fail(
                  "*iter->cur.ptr == \'\\0\'",
                  "/home/khheo/project/benchmark/grep-2.19/lib/mbuiter.h", 178U,
                  "mbuiter_multi_next");
            }
            if (!(iter->cur.wc == 0)) {
              ...
              __assert_fail(
                  "iter->cur.wc == 0",
                  "/home/khheo/project/benchmark/grep-2.19/lib/mbuiter.h", 179U,
                  "mbuiter_multi_next");
            }
          }
          {
    ...
    if ((unsigned long)translation != (unsigned long)name) {
      ...
      if (tmp___7) {
        ...
        if (sizeof(char) == 1UL) {
          ...
          tmp___4 = strlen(name);
          tmp___5 =
              xnmalloc((((tmp___3 + 2UL) + tmp___4) + 1UL) + 1UL, sizeof(char));
          tmp___6 = tmp___5;
        }
        {
          result = (char *)tmp___6;
          sprintf((char * /* __restrict  */)result,
                  (char const * /* __restrict  */) "%s (%s)", translation,
                  name);
        }
...
void i_ring_init(I_ring *ir, int default_val) {}
_Bool i_ring_empty(I_ring const *ir) __attribute__((__pure__));
_Bool i_ring_empty(I_ring const *ir) { return ((_Bool)ir->ir_empty); }
...
static _Bool check_tuning(Hash_table *table) { return ((_Bool)1); }
...
static _Bool enter_dir(FTS *fts, FTSENT *ent) { return ((_Bool)1); }
...
extern __attribute__((__nothrow__)) int(__attribute__((__nonnull__(2)))
                                        fstatfs)(int __fildes,
                                                 struct statfs *__buf);
static _Bool dirent_inode_sort_may_be_useful(int dir_fd) { return ((_Bool)0); }

static _Bool link_count_optimize_ok(FTSENT const *p) { return ((_Bool)0); }
__attribute__((__nothrow__))
FTSENT *(__attribute__((__warn_unused_result__)) fts_read)(FTS *sp);
FTSENT *(__attribute__((__warn_unused_result__)) fts_read)(FTS *sp) {
  register FTSENT *p;
    ...
    if (sp->fts_options & 2) {
      ...
      _L : {
        ...
        if (tmp___3) {
          ...
          if (*tmp___1 == 2) {
            {
              tmp___2 = lstat((char const * /* __restrict  */)(
                                  (char const *)p->fts_accpath),
                              (struct stat * /* __restrict  */) sbp);
            }
            if (tmp___2 == 0) {
              {
...
static FTSENT *fts_sort(FTS *sp, FTSENT *head, size_t nitems) { return (head); }
static FTSENT *fts_alloc(FTS *sp, char const *name, size_t namelen) {
  register FTSENT *p;
  size_t len;
              ...
              8192) {
            {
              while (1) {
                ...
                if ((unsigned long)pattern_end == (unsigned long)pattern) {
                  ...
                  { tmp___3 = __ctype_b_loc(); }
                  if (!((int const) * (*tmp___3 + (int)((unsigned char)*(
                                                      pattern_end + -1))) &
                        8192)) {
                    goto while_break___1;
                  }
...

  {
    if (!(state->magic == 9827862)) {
      ...
      __assert_fail("state->magic == 9827862",
                    "/home/khheo/project/benchmark/grep-2.19/lib/cycle-check.c",
                    60U, "cycle_check");
    }
...
int set_cloexec_flag(int desc, _Bool value) { return (-1); }
extern __attribute__((__nothrow__)) void *(__attribute__((__nonnull__(1)))
...
int set_binary_mode(int fd, int mode___0) { return (0); }
...
kwset_t kwsalloc(char const *trans___0) {
...

  {
    ...
    __o1->next_free =
        tmp___0 + (((__o1->next_free - tmp___1) + (long)__o1->alignment_mask) &
    ...
    text += len;
    {
      ...
      while_break___0:;
        if (!kwset_link) {
          ...
          if ((unsigned long)__o1___0->next_free ==
              (unsigned long)__value___0) {
  ...
  while_break___1:;
    ...
    while_break___3:;
      if (kwset___1->mind > 1) {
        __h___0 = &kwset___1->obstack;
        __o___0 = __h___0;
        __len___0 = (int)(sizeof(*(kwset___1->shift)) *
                          (unsigned long)(kwset___1->mind - 1));
        if (__o___0->chunk_limit - __o___0->next_free < (long)__len___0) {
        ...
        __o1___0->next_free = tmp___6 + (((__o1___0->next_free - tmp___7) +
                                          (long)__o1___0->alignment_mask) &
                                         (long)(~__o1___0->alignment_mask));
        if (__o1___0->next_free - (char *)__o1___0->chunk >
            __o1___0->chunk_limit - (char *)__o1___0->chunk) {
      ...
      if (trans___0) {
        {
          tmp___9 = (char const *)memchr((void const *)trans___0, (int)gc1,
                                         (size_t)256);
          equiv1 = tmp___9;
          tmp___10 =
              (char const *)memchr((void const *)(equiv1 + 1), (int)gc1,
                                   (size_t)((trans___0 + 256) - (equiv1 + 1)));
          equiv2 = tmp___10;
        }
        if (equiv2) {
          {
            tmp___13 = memchr((void const *)(equiv2 + 1), (int)gc1,
                              (size_t)((trans___0 + 256) - (equiv2 + 1)));
          }
          if (tmp___13) {
            gc1help = 256;
          } else {
            ...
            gc1help = (int)(((long)tmp___12 ^ (equiv1 - trans___0)) ^
                            (equiv2 - trans___0));
          }
        }
      }
...
static _Bool setbit_wc(wint_t wc, charclass_word *c) { return ((_Bool)0); }
...
static int utf8 = -1;
int using_utf8(void) { return (utf8); }
...
static token parse_bracket_exp(void) {
              ...
              if (syntax_bits & 1UL) {
                {
                  while (1) {
                    ...
                    if (!lexleft) {
                      ...
                      {
                        tmp___49 =
                            mbs_to_wchar(&_wc___8, lexptr, lexleft, dfa___0);
                        nbytes___8 = tmp___49;
            ...
            if (dfa___0->multibyte) {
              if (wc != 4294967295U) {
                if (wc2 != 4294967295U) {
                  {
                    work_mbc->ranges =
                        (struct __anonstruct_ranges_39 *)maybe_realloc(
                            (void *)work_mbc->ranges, work_mbc->nranges + 2UL,
                  ...
                  if (case_fold) {
                    ...
                    if (tmp___55) {
                      ...
                      (work_mbc->nranges)++;
                      (work_mbc->ranges + tmp___54)->end =
                          (wchar_t)towupper(wc2);
  ...
  while_break___1:;
    if (colon_warning_state == 7) {
      ...
      tmp___70 =
          gettext("character class syntax is [[:space:]], not [:space:]");
    ...
    if (invert) {
      if (!(!dfa___0->multibyte)) {
        ...
        __assert_fail("!dfa->multibyte",
                      "/home/khheo/project/benchmark/grep-2.19/src/dfa.c",
...
static void build_state(state_num s, struct dfa *d) {
...

  {
    ...
    *(d->success + s) = 0;
    ...
    if ((((int)(d->states + s)->constraint >> 4) & 15) &
        (int)(d->states + s)->context) {
      *(d->success + s) |= 2;
    }
          ...
          if (*(d->fails + s)) {
            ...
            if (d->multibyte) {
              ...
              s = transit_state(d, s, &p,
                                (unsigned char const *)((unsigned char *)end));
              mbp = p;
              trans___0 = d->trans;
...
_Bool dfaisfast(struct dfa const *d) __attribute__((__pure__));
_Bool dfaisfast(struct dfa const *d) { return ((_Bool)d->fast); }
...
static char *icatalloc(char *old, char const *new) { return (old); }

static void freelist(char **cpp) {}
static char **enlist(char **cpp, char *new, size_t len) { return (cpp); }
...
static char **addlists(char **old, char **new) { return (old); }
...

  {
    ...
    ri = (size_t)0;
    {
      ...
      case_259 : {
        ...
        goto switch_break;
      case_270 : {
        __assert_fail("!\"neither LPAREN nor RPAREN may appear here\"",
                      "/home/khheo/project/benchmark/grep-2.19/src/dfa.c",
                      3951U, "dfamust");
      }
      case_256 : { mp = allocmust(mp); }
        goto switch_break;
      case_265 : { resetmust(mp); }
        goto switch_break;
      case_269 : {
        rmp = mp;
        mp = mp->prev;
        ...
        *(lmp->left + i) = (char)'\000';
        ...
        i = (size_t)0;
        {
          while (1) {
            ...
            if ((int)*(lmp->right + ((ln - i) - 1UL)) !=
                (int)*(rmp->right + ((rn - i) - 1UL))) {
              goto while_break___1;
            }
            i++;
          };
      ...
      while_break___3 : { tmp___2 = strcmp(result, (char const *)mp->is); }
        if (tmp___2 == 0) {
          exact = (_Bool)1;
      ...
      case_268 : {
        ...
        if ((int)*(lmp___0->right + 0) != 0) {
          if ((int)*(rmp___0->left + 0) != 0) {
            ...
            tp = tmp___5;
            memcpy(
                (void * /* __restrict  */)((void *)tp),
                (void const * /* __restrict  */)((void const *)lmp___0->right),
                lrlen);
            memcpy(
                (void * /* __restrict  */)((void *)(tp + lrlen)),
                (void const * /* __restrict  */)((void const *)rmp___0->left),
                rllen);
        ...
        {
          lmp___0->right =
              icatalloc(lmp___0->right, (char const *)rmp___0->right);
        }
        if ((int)*(lmp___0->is + 0) != 0) {
          goto _L;
        } else {
      ...
      case_0:
        goto done;
      switch_default : { mp = allocmust(mp); }
        if (275L <= t) {
          ...
          j___0 = 0;
          {
            while (1) {
              ...
              {
                tmp___6 = tstbit((unsigned int)j___0,
                                 (charclass_word * /* const  */)(*ccl));
              }
              if (tmp___6) {
                goto while_break___4;
              }
        ...
        while_break___4:;
          ...
          t = (token)j___0;
          {
            while (1) {
              ...
              {
                tmp___7 = tstbit((unsigned int)j___0,
                                 (charclass_word * /* const  */)(*ccl));
              }
              if (tmp___7) {
                if (case_fold) {
...
void kwsinit(kwset_t *kwset___1) {
  ...
  while_break : { *kwset___1 = kwsalloc((char const *)(trans)); }
  }
}
static char *out;
...
char *mbtoupper(char const *beg, size_t *n, mb_len_map_t **len_map_p) {
...

  {
    ...
    if (!out) {
      ...
      __assert_fail("out",
                    "/home/khheo/project/benchmark/grep-2.19/src/searchutils.c",
                    97U, "mbtoupper");
    }
    if (!len_map) {

      __assert_fail("len_map",
                    "/home/khheo/project/benchmark/grep-2.19/src/searchutils.c",
                    98U, "mbtoupper");
    }
    if (*n == 0UL) {
...
static off_t dossified_pos(off_t byteno) { return (byteno); }
...

  {
    ...
    if (pending_sep) {
      if (align_tabs) {
        ...
        fputs_unlocked((char const * /* __restrict  */) "\t\b",
                       (FILE * /* __restrict  */) stdout);
      }
      { print_sep((char)sep); }
    }
...
void usage(int status) {
...

  {
    if (status != 0) {
      ...
      tmp___4 = gettext("Example: %s -i \'hello world\' menu.h "
      ...
      tmp___5 = gettext(
          ...
          "newline-separated fixed strings\n  -G, --basic-regexp        "
      ...
      tmp___6 = gettext(
          ...
          "PATTERN to match only whole words\n  -x, --line-regexp         "
      ...
      tmp___8 = gettext(
          ...
          "matches\n  -b, --byte-offset         print the byte offset with "
          "output lines\n  -n, --line-number         print line number with "
          "output lines\n      --line-buffered       flush output on every "
          "line\n  -H, --with-filename       print the file name for each "
          "match\n  -h, --no-filename         suppress the file name prefix on "
          "output\n      --label=LABEL         use LABEL as the standard input "
          "file name prefix\n");
      printf((char const * /* __restrict  */)((char const *)tmp___8));
      tmp___9 =
          gettext("  -o, --only-matching       show only the part of a line "
                  "matching PATTERN\n  -q, --quiet, --silent     suppress all "
                  "normal output\n      --binary-files=TYPE   assume that "
                  "binary files are TYPE;\n                            TYPE is "
                  "\'binary\', \'text\', or \'without-match\'\n  -a, --text    "
                  "            equivalent to --binary-files=text\n");
      printf((char const * /* __restrict  */)((char const *)tmp___9));
      tmp___10 = gettext(
          "  -I                        equivalent to "
          "--binary-files=without-match\n  -d, --directories=ACTION  how to "
          "handle directories;\n                            ACTION is "
          "\'read\', \'recurse\', or \'skip\'\n  -D, --devices=ACTION      how "
          "to handle devices, FIFOs and sockets;\n                            "
          "ACTION is \'read\' or \'skip\'\n  -r, --recursive           like "
          "--directories=recurse\n  -R, --dereference-recursive  likewise, but "
          "follow all symlinks\n");
      printf((char const * /* __restrict  */)((char const *)tmp___10));
      tmp___11 = gettext("      --include=FILE_PATTERN  search only files that "
                         "match FILE_PATTERN\n      --exclude=FILE_PATTERN  "
                         "skip files and directories matching FILE_PATTERN\n   "
                         "   --exclude-from=FILE   skip files matching any "
                         "file pattern from FILE\n      --exclude-dir=PATTERN  "
                         "directories that match PATTERN will be skipped.\n");
      printf((char const * /* __restrict  */)((char const *)tmp___11));
      tmp___12 =
          gettext("  -L, --files-without-match  print only names of FILEs "
                  "containing no match\n  -l, --files-with-matches  print only "
                  "names of FILEs containing matches\n  -c, --count            "
      ...
      tmp___13 =
          gettext("\nContext control:\n  -B, --before-context=NUM  print NUM "
                  "lines of leading context\n  -A, --after-context=NUM   print "
                  "NUM lines of trailing context\n  -C, --context=NUM         "
                  "print NUM lines of output context\n");
      printf((char const * /* __restrict  */)((char const *)tmp___13));
      tmp___14 = gettext(
          "  -NUM                      same as --context=NUM\n      "
          "--color[=WHEN],\n      --colour[=WHEN]       use markers to "
          "highlight the matching strings;\n                            WHEN "
          "is \'always\', \'never\', or \'auto\'\n  -U, --binary              "
          "do not strip CR characters at EOL (MSDOS/Windows)\n  -u, "
          "--unix-byte-offsets   report offsets as if CRs were not there\n     "
          "                       (MSDOS/Windows)\n\n");
      printf((char const * /* __restrict  */)((char const *)tmp___14));
      tmp___15 = gettext(
          "\'egrep\' means \'grep -E\'.  \'fgrep\' means \'grep -F\'.\nDirect "
          "invocation as either \'egrep\' or \'fgrep\' is deprecated.\n");
      printf((char const * /* __restrict  */)((char const *)tmp___15));
      tmp___16 =
          gettext("When FILE is -, read standard input.  With no FILE, read . "
                  "if a command-line\n-r is given, - otherwise.  If fewer than "
                  "two FILEs are given, assume -h.\nExit status is 0 if any "
                  "line is selected, 1 otherwise;\nif any error occurs and -q "
                  "is not given, the exit status is 2.\n");
      ...
      fputs_unlocked((char const * /* __restrict  */)((char const *)tmp___19),
                     (FILE * /* __restrict  */) stdout);
    }
    { exit(status); }
  }
...
int main(int argc, char **argv) {
...

  {
    ...
    }
    {
                    ...
                    if (tmp___23) {
                      ...
                      if (tmp___18) {
                        ...
                        if (tmp___19) {
                          {
                            tmp___20 =
                                strcasecmp((char const *)optarg, "if-tty");
                          }
                          if (tmp___20) {
                            show_help = 1;
                          } else {
      ...
      case_135:
        ...
        {
          add_exclude(excluded_directory_patterns, (char const *)optarg,
                      1 << 28);
        }
        goto switch_break;
      case_136:
  ...
  while_break:;
    ...
    if (show_version) {
      ...
      version_etc(stdout, program_name, "GNU grep", "2.19", tmp___35, tmp___34,
                  (char *)((void *)0));
      exit(0);
    }
    if (show_help) {
