#/bin/bash
radamsa_result_analysis=${home_folder}/result/radamsa_result/analysis/option_${option}/input$1_fuzzed

origin_hangs=`grep -o '124' ${origin_result}/input$1_fuzzed | wc -l`
reduced_hangs=`grep -o '124' ${reduced_result}/input$1_fuzzed | wc -l`
robust_reduced_hangs=`grep -o '124' ${robust_reduced_result}/input$1_fuzzed | wc -l `
...
origin_crashes=`grep -o '13[0-9]' ${origin_result}/input$1_fuzzed | wc -l`
...
reduced_crashes=`grep -o '13[0-9]' ${reduced_result}/input$1_fuzzed | wc -l`
...
robust_reduced_crashes=`grep -o '13[0-9]' ${robust_reduced_result}/input$1_fuzzed | wc -l`

origin_exit0=`grep -o '0' ${origin_result}/input$1_fuzzed | wc -l`
origin_exit1=`grep -o '1$' ${origin_result}/input$1_fuzzed | wc -l`
origin_successful_exit=`expr ${origin_exit0} + ${origin_exit1}`

reduced_exit0=`grep -o '0' ${reduced_result}/input$1_fuzzed | wc -l`
reduced_exit1=`grep -o '1$' ${reduced_result}/input$1_fuzzed | wc -l`
reduced_successful_exit=`expr ${reduced_exit0} + ${reduced_exit1}`

robust_reduced_exit0=`grep -o '0' ${robust_reduced_result}/input$1_fuzzed | wc -l`
robust_reduced_exit1=`grep -o '1$' ${robust_reduced_result}/input$1_fuzzed | wc -l`
