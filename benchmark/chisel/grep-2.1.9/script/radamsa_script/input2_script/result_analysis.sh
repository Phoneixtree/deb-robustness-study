...
echo  "origin_bin has executed "${origin_exc_}" exceptions" >> result/result
echo -e "reduced_bin has "${reduced_exc_}" exceptions\n" >> result/result
