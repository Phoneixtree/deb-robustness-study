...
def train():
    # 12
    train_run("""train_input/train_input1""")
    ...
    train_run("""train_input/train_input8""")
    execute("""rm -rf d1""")
    
    train_run("""train_input/train_input9""")
    execute("""rm -rf d1""")
    
    train_run("""train_input/train_input10""")
    execute("""rm -rf d1""")
    
    train_run("""train_input/train_input11""")
    execute("""rm -rf d1""")
    
    execute("""/bin/mkdir d1""")
    train_run("""train_input/train_input12""")
    execute("""rm -rf d1""")    
        
    execute("""/bin/mkdir d1""")    
    train_run("""train_input/train_input13""")
    execute("""rm -rf d1""")    
