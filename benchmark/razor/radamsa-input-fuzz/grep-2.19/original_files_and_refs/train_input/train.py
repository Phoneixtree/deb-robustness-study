...
def train():
    ...
    train_run( """ "a" ./input2 """)
    train_run( """ "a" -v -H -r ./input_dir""")
    train_run( """ "1" -h -r ./input_dir""")
    train_run( """ -n "si" ./input2""")
    train_run( """ "1" -r ./input_dir -l""")
    train_run( """ "1" -r ./input_dir -L""")
    train_run( """ "randomtext" -r ./input_dir -c""")
    train_run( """ -o [r][a][n][d]* ./input2""")
    train_run( """ "1" -r ./input_dir -q""")
    train_run( """ "1" -r ./input_dir -s""")
    train_run( """ -v "a" ./input2""")
    train_run( """ -i "Si" ./input2""")
    train_run( """ -w "Si" ./input2""")
    train_run( """ -x "Don't" ./input2""")
    train_run( """ -F "randomtext*" ./input2""")
    train_run( """ -E "randomtext*" ./input2""")
    train_run( """ "ye " ./input""")
    train_run( """ "cold" ./input""")
    train_run( """ "not exist" ./input""")
    train_run( """ ^D ./input2""")
    train_run( """ .$ ./input2""")
    train_run( """ \^ ./input2""")
    train_run( """ \^$ ./input2""")
    train_run( """ ^[AEIOU] ./input2""")
    train_run( """ ^[^AEIOU] ./input2""")
    train_run( """ -E "free[^[:space:]]+" ./input2""")
    train_run( """ -E '\b(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?\.){3}(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)' ./input""")
