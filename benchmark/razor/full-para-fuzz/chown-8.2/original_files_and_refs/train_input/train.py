...
def train():
  execute('touch file1')
  execute('touch file2')
  train_run('train_input1')
  execute('rm -rf file1 file2')
  
  execute('touch file1')
  execute('touch file2')
  train_run('train_input/train_input11')
  execute('rm -rf file1 file2')

  execute('mkdir -p d1/d1/d1')
  execute('touch d1/d1/d1/file')
  execute('mkdir -p d2/d2/d2')
  execute('touch d2/d2/d2/file')
  train_run('train_input/train_input2')
  execute('rm -rf d1 d2')
  ...
  execute('mkdir -p d2/d2/d2')
  execute('touch d2/d2/d2/file')
  train_run('train_input/train_input22')
  execute('rm -rf d1 d2')
  ...
  execute('mkdir -p d2/d2/d2')
  execute('touch d2/d2/d2/file')  
  train_run('train_input/train_input3')
  execute('ls -al d1/d1/d1/file | cut -d ' ' -f 4 >temp1')
  execute('ls -al d2/d2/d2/file | cut -d ' ' -f 4 >temp2')
  execute('diff -q temp1 temp2 >&/dev/null || exit 1')
  execute('rm -rf d1 d2')
  ...
  execute('mkdir -p d2/d2/d2')
  execute('touch d2/d2/d2/file')  
  train_run('train_input/train_input33')
  execute('ls -al d1/d1/d1/file | cut -d ' ' -f 4 >temp1')
  execute('ls -al d2/d2/d2/file | cut -d ' ' -f 4 >temp2')
  execute('diff -q temp1 temp2 >&/dev/null || exit 1')
  execute('rm -rf d1 d2')
  ...
  execute('mkdir -p d2/d2/d2')
  execute('touch d2/d2/d2/file')  
  train_run('train_input/train_input4')
  execute('ls -al d1/d1/d1/file | cut -d ' ' -f 4 >temp1')
  execute('ls -al d2/d2/d2/file | cut -d ' ' -f 4 >temp2')
  execute('diff -q temp1 temp2 >&/dev/null || exit 1')
  execute('rm -rf d1 d2')
  ...
  execute('mkdir -p d2/d2/d2')
  execute('touch d2/d2/d2/file')  
  train_run('train_input/train_input44')
  execute('ls -al d1/d1/d1/file | cut -d ' ' -f 4 >temp1')
  execute('ls -al d2/d2/d2/file | cut -d ' ' -f 4 >temp2')
  execute('diff -q temp1 temp2 >&/dev/null || exit 1')
  execute('rm -rf d1 d2')
  ...
  execute('ln -s file2 symfile2')  
  train_run('train_input/train_input5')  
  execute('rm -rf file1 file2 symfile1 symfile2')

  execute('touch file1')
  execute('touch file2')
  execute('ln -s file1 symfile1')
  execute('ln -s file2 symfile2')  
  train_run('train_input/train_input55')  
  execute('rm -rf file1 file2 symfile1 symfile2')
  ...
  execute('ln -s file1 symfile1')
  execute('ln -s file2 symfile2')  
  train_run('train_input/train_input6')  
  execute('rm -rf file1 file2 symfile1 symfile2')  
  ...
  execute('ln -s file1 symfile1')
  execute('ln -s file2 symfile2')  
  train_run('train_input/train_input66')  
  execute('rm -rf file1 file2 symfile1 symfile2') 
  ...
  execute('ln -s file1 symfile1')
  execute('ln -s file2 symfile2')  
  train_run('train_input/train_input7')  
  execute('rm -rf file1 file2 symfile1 symfile2')  
  ...
  execute('ln -s file1 symfile1')
  execute('ln -s file2 symfile2')  
  train_run('train_input/train_input77')  
  execute('rm -rf file1 file2 symfile1 symfile2')
